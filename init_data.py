...
def create_website_types():
    ...
    website_types = [
        ...
        {
            'name': 'starter_mobile_app',
            'description': 'A focused mobile app for simple business information and basic service delivery.',
        ...
        {
            'name': 'business_mobile_app',
            'description': 'A mobile app with user accounts, dashboards, notifications, and database integration.',
            'features': 'Android and iOS apps\nCustom UI/UX design\nUser accounts\nPush notifications\nDatabase integration',
            'min_price': 25000,
            'max_price': 60000,
            'estimated_days': 45,
            'icon': 'briefcase',
        ...
        {
            'name': 'ecommerce_mobile_app',
            'description': 'A mobile shopping app with products, secure checkout, payments, and order tracking.',
        ...
        {
            'name': 'custom_mobile_app',
            'description': 'A fully custom Android and iOS application built around advanced business requirements.',
            'features': 'Custom Android and iOS development\nAdvanced integrations\nReal-time features\nAdmin dashboard\nApp store deployment',
            'min_price': 60000,
            'max_price': 150000,
            'estimated_days': 90,
            'icon': 'rocket',
